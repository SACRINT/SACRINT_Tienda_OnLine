...
<PriceRange min={0} max={10000} value={[100, 5000]} onValueChange={handleChange} />;
```
...
<Image src={product.image} alt={product.name} width={400} height={400} priority={isAboveFold} />;
```
