...
const PREDEFINED_RANGES: { label: string; value: DatePeriod; getDates: () => DateRange }[] = [
  {
    label: 'Today',
    value: 'today',
    getDates: () => ({
...
export function MobileDateRangePicker({ value, onChange, className = '' }: DateRangePickerProps) {
  const [selectedPeriod, setSelectedPeriod] = useState<DatePeriod>('last7days')
