...
import { Users, TrendingUp, DollarSign, ShoppingCart, Award, AlertCircle } from 'lucide-react'
...
export function CustomerSegmentation({ customers, summary }: CustomerSegmentationProps) {
  const segmentGroups = {
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600">RFM Analysis (Recency, Frequency, Monetary)</p>
      </div>
      ...
      <div className="space-y-4">
        {Object.entries(segmentGroups).map(([segmentKey, segmentCustomers]) => {
          ...
          return (
            <Card key={segmentKey} className={`border-2 ${config.color.split(' ')[2]}`}>
              <CardHeader>
          ...
          <div className="grid gap-4 md:grid-cols-3">
            <div>
              ...
              <p className="text-sm text-gray-600">
                How recently did the customer make a purchase? (1-5, 5 = most recent)
              </p>
            </div>
            <div>
