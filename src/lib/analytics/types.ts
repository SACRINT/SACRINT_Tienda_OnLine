...
export const DATE_PERIODS = ['today', 'yesterday', 'last7days', 'last30days', 'last90days', 'custom'] as const
export type DatePeriod = typeof DATE_PERIODS[number]

export const REPORT_TYPES = ['sales', 'customers', 'products', 'coupons', 'tax-shipping'] as const
