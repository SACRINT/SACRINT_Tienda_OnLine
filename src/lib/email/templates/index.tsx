...
export const OrderConfirmationEmail = (data: any) => (
...
export const PaymentFailedEmail = (data: any) => <div>Payment Failed</div>;
export const AccountVerificationEmail = (data: any) => (
...
export const ProductRestockedEmail = (data: any) => (
  <div>Product Restocked</div>
);
