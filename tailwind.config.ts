...
import { COLORS, SPACING, TYPOGRAPHY, SHADOWS } from "./src/lib/constants/design-tokens";
...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        h1: TYPOGRAPHY.h1.size,
        h2: TYPOGRAPHY.h2.size,
        h3: TYPOGRAPHY.h3.size,
        body: TYPOGRAPHY.body.size,
        small: TYPOGRAPHY.small.size,
      },
      fontFamily: {
